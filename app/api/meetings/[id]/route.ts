...
const include = {
  ...
  attendances: {
    include: { student: { select: { StudentName: true, StudentID: true } } },
  },
};
...
export async function GET(
  ...
  const r = await prisma.projectMeeting.findUnique({
...
export async function PUT(
  ...
  if (b.MeetingDateTime != null)
    data.MeetingDateTime = new Date(b.MeetingDateTime);
  ...
  if (b.MeetingStatusDescription != null)
    data.MeetingStatusDescription = b.MeetingStatusDescription;
